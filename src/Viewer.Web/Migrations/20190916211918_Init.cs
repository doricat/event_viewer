        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationId = table.Column<string>(maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_ApplicationId_Category",
                table: "Events",
                columns: new[] { "ApplicationId", "Category" });

            migrationBuilder.CreateIndex(
                name: "IX_Events_ApplicationId_Level",
                table: "Events",
                columns: new[] { "ApplicationId", "Level" });

            migrationBuilder.CreateIndex(
                name: "IX_Events_ApplicationId_Level_TimeStamp",
                table: "Events",
